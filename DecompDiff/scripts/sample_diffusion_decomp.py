...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default="configs/sampling_drift.yml")
    ...
    parser.add_argument('--prior_mode', type=str, choices=['subpocket', 'ref_prior', 'beta_prior'], default='ref_prior')
