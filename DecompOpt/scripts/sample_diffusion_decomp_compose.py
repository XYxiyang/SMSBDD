...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default="./configs/sampling_10_ret.yml")
    ...
    parser.add_argument('--ckpt_path', type=str, default="./pretrained/decompdiff.pt")
    ...
    parser.add_argument('--prior_mode', type=str, choices=['subpocket', 'ref_prior', 'beta_prior'], default='beta_prior')
    ...
    parser.add_argument('--reference_arm_path', type=str, default='./outputs_test/best_record/best_mol_arms.pt')
